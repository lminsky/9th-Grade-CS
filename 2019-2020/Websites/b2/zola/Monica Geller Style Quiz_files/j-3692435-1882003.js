...
(function(){
    ...
    (function() {
    var p = "3692435", n = JSON.parse('[]'), w = window, f = function(s) {
...
o.is = function platform(navigator) {
    ...
    var data = {
    params:window.ftParams_3692435||'',
    guid:window.ftGUID_3692435||'',
    confID:window.ftConfID_3692435||'0',
    ftReturn: window.ftReturn_3692435||'',
    keyword:window.ftKeyword_3692435||'',
    ftId:window.ftId_3692435||'',
    ftImpId:window.ftImp3692435 && window.ftImp3692435.impID || '',
    campaignID: '106233',
    cID:'77240',
    pID:'3692435',
    creativeID:'1882003',
    exttrack:["https://dpm.demdex.net/ibs:dpid=3047&dpuuid=[%FT_GUID%]","https://imp.control.kochava.com/track/impression?campaign_id=koespn-score-center-android-prod-46p3gj8ng460d6c5c40978&network_id=5648&device_id=[%IDFA%]&creative_size=1+2&data_id=[ftqs:[ft_custom]]&d9id=[%D9PASS%]&timestamp=[FT_TIMESTAMP]&user_id=[%FT_GUID%]&version_id=[%FT_CONFID%]&placement_id=3692435&campaignid=106233&impression_id=[%FT_IMPRESSIONID%]&creative_id=1882003&site_id=381&device_id_type=adid","https://imp.control.kochava.com/track/impression?campaign_id=koespn-ios-prod-v2nb2cc19654741c&network_id=5647&device_id_type=idfa&device_id=[%IDFA%]&creative_size=1+2&data_id=[ftqs:[ft_custom]]&d9id=[%D9PASS%]&timestamp=[FT_TIMESTAMP]&user_id=[%FT_GUID%]&version_id=[%FT_CONFID%]&placement_id=3692435&campaignid=106233&impression_id=[%FT_IMPRESSIONID%]&creative_id=1882003&site_id=381"],
    extscript:[""],
    clickTags: ['http://servedby.flashtalking.com/click/8/106233;3692435;1882003;210;[FT_CONFID]/?g=[FT_GUID]&random=[FT_RANDOM]&ft_width=1&ft_height=2&url=https://smart.link/5db7045976ed5?version_id=[%FT_CONFID%]&user_id=[%FT_GUID%]&timestamp=[FT_TIMESTAMP]&site_id=381&placement_width=1&placement_id=3692435&placement_height=2&data_id=[ftqs:[ft_custom]]&d9id=[%D9PASS%]&creative_id=1882003&click_id=[%FT_IMPRESSIONID%]&campaignid=106233&device_id=[%IDFA%]'],
    statBaseURL: 'http://stat8.flashtalking.com/reportV3/ft.stat?133591107-3692435;1882003;',
    centreAd: true,
    width:1,
    height:2,
    adType:'altimage'.toLowerCase(),
    altimg:'http://cdn.flashtalking.com/xre/369/3692435/1882003/image/1882003.gif',
    viewableImpressionURL: 'http://servedby.flashtalking.com/imp/8/106233;3692435;202;pixel;ESPN;ESPNPlusAdobeTracking/?',
    stump: 'http://servedby.flashtalking.com',
    altimghref:'http://servedby.flashtalking.com/click/8/106233;3692435;1882003;210;[FT_CONFID]/?g=[FT_GUID]&random=[FT_RANDOM]&ft_width=1&ft_height=2&url=https://smart.link/5db7045976ed5?version_id=[%FT_CONFID%]&user_id=[%FT_GUID%]&timestamp=[FT_TIMESTAMP]&site_id=381&placement_width=1&placement_id=3692435&placement_height=2&data_id=[ftqs:[ft_custom]]&d9id=[%D9PASS%]&creative_id=1882003&click_id=[%FT_IMPRESSIONID%]&campaignid=106233&device_id=[%IDFA%]',
    divID:'ftdiv3692435',
    altimgID:'ftalt3692435',
    alttext:'Click here',
    w: window,
    adDisplayed: false,
    customPos: false,
    ...
    append: !!(window.ftImp3692435 && parseInt(window.ftImp3692435.jsAppend, 10) === 1),
    ...
    secure: !!(location.protocol === 'https:' || /^https:/.test((document.getElementById('ftscript_m3692435') || {}).src) || window.qs && typeof qs.get === 'function' && /^https:/.test(qs.get('ifsrc',''))),
    scriptLocation: document.getElementById('ftscript_m3692435'),
    pageVisible: 'maybe',
