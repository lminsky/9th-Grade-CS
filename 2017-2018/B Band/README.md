...
### Course Description
In this course students will explore a variety of topics within Computer Science. We will start with a unit on web development and create simple websites using HTML, CSS, and Javascript. We will then focus on programming using the p5 Javascript library with the goal of creating a basic Pong-style game. After that we will learn about video game design using the Unity game engine. Finally we will explore physical computer using the Arduino microcontroller. Students will work to better understand the capabilities and constraints of software systems.
